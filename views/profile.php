...
<body>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div>
                <?php if (isset($_SESSION['user'])): ?>
                    <a href="index.php?controller=user&action=showProfile" class="btn btn-secondary">Profile</a>
                <?php else: ?>
    ...
    <div class="container">
        ...
        <?php if (isset($_SESSION['user'])): ?>
            ...
            <?php endif; ?>
            <form action="index.php?controller=user&action=updateProfilePicture" method="post" enctype="multipart/form-data">
                <label for="profile_picture">Upload Profile Picture:</label>
                <input type="file" name="profile_picture" id="profile_picture" accept="image/*">
                <button type="submit" class="btn btn-primary mt-2">Update Profile Picture</button>
            </form>
        <?php else: ?>
            <p>You need to <a href="index.php?controller=user&action=showLoginForm">login</a> to view your profile.</p>
        <?php endif; ?>
    </div>
